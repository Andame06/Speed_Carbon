                        ...
                        <div class="modal-body">
                            <div class="form-row">
                                    ...
                                    <select name="id" id="id" class="form-control">
                                        ...
                                        if ($listaEmpleados->num_rows > 0) {
                                            foreach ($listaEmpleados as $empleado) {
                                                ...
                                                echo " <option value='{$empleado['id_empleado']}'> {$empleado['id']} {$empleado['nombre']} {$empleado['apellidoP']} {$empleado['apellidoM']} {$empleado['correo']} </option> ";
                                            }
                                        } else {
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" require name="precio_registro" id="precio_registro" placeholder="" value="<?php echo $precio_registro ?>">
                                    <br>
                                </div>
                                    ...
                                    <select name="id_comprador" id="id_comprador" class="form-control">
                                        ...
                                        if ($listaCompradores->num_rows > 0) {
                                            foreach ($listaCompradores as $comprador) {
                                                ...
                                                echo " <option value='{$comprador['id_comprador']}'> {$comprador['id_comprador']} {$comprador['nombre_comprador']} {$comprador['apellido_comprador']} {$comprador['Tel_comprador']} {$comprador['Direccion_comprador']} {$comprador['Edad_comprador']} </option> ";
                                            }
                                        } else {
                                            echo "<h2> No tenemos resultados </h2>";
                                        }
                                ...
                                <!-- FIN SELECTOR CLIENTE -->
                                <div class="form-group col-md-12">
                                    <label for="detalle">Ganancia</label>
                                    <input type="text" class="form-control" require name="Ganancia" id="Ganancia" placeholder="" value="<?php echo $Ganancia ?>">
                                    <br>
                                </div>
                            </div>
                        </div>
