    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../paginas/index.php">
                ...
                <div class="sidebar-brand-text mx-3">Speed Carbon </div>
            </a>
            ...
            <!-- Menu de Clientes -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../Compradores/index.php" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <!-- Menu de Facturas -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../Tipo_Vehiculo/index.php" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <!-- Menu de Facturas -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../Vehiculo/index.php" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <!-- Menu de Facturas -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="../Registro/index.php" aria-expanded="true" aria-controls="collapseTwo">
